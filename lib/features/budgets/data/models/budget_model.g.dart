...
class BudgetModelAdapter extends TypeAdapter<BudgetModel> {
  ...
  BudgetModel read(BinaryReader reader) {
    ...
    return BudgetModel(
      ...
      name: fields[1] as String? ?? 'Unknown Budget',
      categoryId: fields[2] as String? ?? '',
      amount: fields[3] as double? ?? 0.0,
      spent: fields[4] as double? ?? 0.0,
      period: fields[5] as BudgetPeriod? ?? BudgetPeriod.monthly,
      startDate: fields[6] as DateTime? ?? DateTime.now(),
      endDate: fields[7] as DateTime? ?? DateTime.now().add(Duration(days: 30)),
      isActive: fields[8] as bool? ?? true,
      alertEnabled: fields[9] as bool? ?? false,
      alertThreshold: fields[10] as double? ?? 80.0,
